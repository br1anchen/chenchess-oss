...
function recordImportedBuiltIns(
...
function recordBuiltInShadowName(
  name: string,
  shadowedBuiltIns: Set<string>,
): void {
...
function unsafeIntersectionValue(
  ...
  return first !== undefined && unsafeMembers.every((member) => member !== null)
    ? first
    : null
}
...
function dictionaryValueTypesFromMapped(
...
function dictionaryValueTypesFromReference(
  ...
  return dictionaryValueTypesFromAlias(
    name,
    type,
    environment,
    substitutions,
...
function dictionaryValueTypesFromAlias(
  name: string,
  type: ESTree.TSTypeReference,
  environment: TypeEnvironment,
  substitutions: TypeAliasEnvironment,
...
function dictionaryValueTypes(
  ...
  return dictionaryValueTypesFromReference(
    unwrapped,
    environment,
    substitutions,
    resolvingAliases,
...
function classifyWideningTypeLiteral(
  type: ESTree.TSTypeLiteral,
): WideningTarget | null {
